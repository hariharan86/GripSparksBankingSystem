...
<head>
    ...
    <title>SmartBanks | Customers</title>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:#b3b3ff; opacity:1;"> 
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                ...
                <select name="reciever" id="dropdown" required>
                    <option required>---Select Reciever---</option>
                <?php
                ...
                <br><br><br>
                        ...
                        <br><br><br>
                        <button id="transfer"  name="transfer" class="btn btn-danger" ><b>Transfer</b></button>
                        </form>
        </div>
    </div>
</div>
